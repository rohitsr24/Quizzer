...
public class ScienceActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        Boolean answer1;
        RadioButton question1 =  this.findViewById(R.id.option_1_4);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer3;
        RadioButton question3 =  this.findViewById(R.id.option3_3);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer4;
        RadioButton question4 =  this.findViewById(R.id.option4_1);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer7;
        RadioButton question7 =  this.findViewById(R.id.option7_4);
        ...
        if (answer8.equals("laws"+" "+"of" +" "+"photoelectric"+" " +"effect")) {
            answer8_score = 1;
        } else {
            answer8_score = 0;
        }
