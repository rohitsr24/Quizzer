...
public class BiologyActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        Boolean answer1;
        RadioButton question1 =  this.findViewById(R.id.option_1_1);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer3;
        RadioButton question3 =  this.findViewById(R.id.option3_2);
        ...
        CheckBox question3_choice1 =  this.findViewById(R.id.option5_1);
        CheckBox question2_choice2 =  this.findViewById(R.id.option5_2);
        CheckBox question3_choice3 =  this.findViewById(R.id.option5_3);
        CheckBox question3_choice4 =  this.findViewById(R.id.option5_4);
        answer5_choice1 = question3_choice1.isChecked();
        answer5_choice2 = question2_choice2.isChecked();
        answer5_choice3 = question3_choice3.isChecked();
        answer5_choice4 = question3_choice4.isChecked();
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer7;
        RadioButton question7 =  this.findViewById(R.id.option7_1);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer9;
        RadioButton question9 =  this.findViewById(R.id.option9_4);
