...
public class CurrentAffairsActivity extends AppCompatActivity {
    ...
    public void submitAnswers(View view) {
        ...
        String answer2;
        EditText question2 =  this.findViewById(R.id.option2);
        answer2 = question2.getText().toString().toLowerCase();
        if (answer2.equals("07"+"/"+ "29")) {
            answer2_score = 1;
        } else {
            answer2_score = 0;
        }
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer3;
        RadioButton question3 =  this.findViewById(R.id.option3_1);
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer4;
        RadioButton question4 =  this.findViewById(R.id.option4_2);
        ...
        // if it's equal to the correct answer otherwise 0.
        String answer8;
        EditText question8 =  this.findViewById(R.id.option8);
        answer8 = question8.getText().toString().toLowerCase();
        if (answer8.equals("innovate"+" "+"india"+" "+"platform")) {
            answer8_score = 1;
        } else {
            answer8_score = 0;
        }
        ...
        // returns the score 1 if it's equal to the correct answer otherwise 0 at the final stage.
        Boolean answer9;
        RadioButton question9 =  this.findViewById(R.id.option9_1);
